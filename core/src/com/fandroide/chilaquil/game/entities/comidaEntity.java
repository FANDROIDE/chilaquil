 ...
 */
public class comidaEntity extends Actor {
    ...
    private float X,Y;
    public comidaEntity(World world,Texture texture, Vector2 position){
        this.world=world;
    ...
    public void act(float delta) {
        if(!alive){
            System.out.println("desaparecio la comida");
